...
void Array::insertAtBeginning(int element)
{
...
void Array::deleteAtPosition(int position)
{
    if (size == 0 || position < 0 || position >= size)
    {
        std::cout << "Invalid position or array is empty. Cannot delete." << std::endl;
        return;
    }
